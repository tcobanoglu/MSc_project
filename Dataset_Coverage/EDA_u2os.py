# -*- coding: utf-8 -*-
"""
Created on Thu Nov 18 14:08:14 2021
...
df = pd.DataFrame({"Reported Kinases":list(KS_group["Kinase"]),
                   'Unreported Kinases':list(KS_no_group["Kinase"]) }, index=index)

ax = df.plot.bar(rot=0,color={"Reported Kinases":"cyan", "Unreported Kinases": "purple"},figsize=(12,10))
...
plt.ylabel('Number of hits',size=14)
plt.xticks(size=12)
plt.yticks(size=12)
